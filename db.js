...
router.post('/', (req, res) => {
  ...
  const reminder = {
    ...
    time: req.body.time,                    // 'HH:MM' 24hr, in the USER's local wall-clock time
    tzOffsetMinutes: Number.isFinite(req.body.tzOffsetMinutes) ? req.body.tzOffsetMinutes : 0, // see reminderLogic.js
